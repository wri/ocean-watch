...
import MiniExploreDatasetsActions from 'components/mini-explore/datasets-sidebar/dataset-actions';

export default function DatasetsSidebar({ datasetGroups, handleAddMap }) {
  const expandedGroupsByDefault = useMemo(() => datasetGroups.map(({ id }) => id), [datasetGroups]);

  return (
    <div className="datasets-sidebar">
      <Accordion allowMultipleExpanded allowZeroExpanded preExpanded={expandedGroupsByDefault}>
              ...
              <div className="dataset-group">
                ...
                <AccordionItemPanel>
                  <DatasetCardList
                    ...
                    list={datasets}
                    actions={<MiniExploreDatasetsActions handleAddMap={handleAddMap} />}
                  />
                </AccordionItemPanel>
              </div>
            </AccordionItem>
