...
export default function WidgetSidebarContainer({ widgetIds, params, adapter }) {
  if (params.geostore_id) {
    return <WidgetSidebar adapter={adapter} widgetIds={widgetIds} params={params} />;
  }
  ...
  return (
    <div className="widgets-sidebar">
      ...
      >
        ...
        <p>
          The graphs will show the concentration of dissolved oxygen, and nutrients at the mouths of
          the rivers in the selected area
        </p>
      </div>
      <CardPlaceholder />
      <CardPlaceholder />
